...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-polymer-cli/node_modules/polymer-cli/lib/args.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header medium">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-polymer-cli/node_modules/polymer-cli/lib/args.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-polymer-cli/node_modules/polymer-cli/lib/</a> &#187; args.js</div>
</div>
<div class="body">
...
exports.globalArguments = [
    {
        ...
        description: 'The environment to use to specialize certain commands, '
            + 'like build',
        type: <span class="fstat-no" title="function not covered" >function (value) {</span>
<span class="cstat-no" title="statement not covered" >            return environments_1.buildEnvironment(value);</span>
        },
        group: 'global',
    },
    {
