...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-polymer-cli/node_modules/polymer-cli/lib/commands/test.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-polymer-cli/node_modules/polymer-cli/lib/commands/test.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-polymer-cli/node_modules/polymer-cli/lib/commands/</a> &#187; test.js</div>
</div>
<div class="body">
...
<span class="cstat-no" title="statement not covered" >        this.name = 'test';</span>
<span class="cstat-no" title="statement not covered" >        this.description = 'Runs web-component-tester';</span>
<span class="cstat-no" title="statement not covered" >        this.args = [</span>
    ...
    run<span class="fstat-no" title="function not covered" >(_options, _config) {</span>
        // Defer dependency loading until this specific command is run
<span class="cstat-no" title="statement not covered" >        const wct = require('web-component-tester');</span>
<span class="cstat-no" title="statement not covered" >        return wct.cli.run(process.env, process.argv.slice(3), process.stdout);</span>
    }
}
